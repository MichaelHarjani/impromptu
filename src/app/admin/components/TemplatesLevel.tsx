...
interface TemplatesLevelProps {
  bank: QuestionBank;
}

export default function TemplatesLevel({ bank }: TemplatesLevelProps) {
  ...
  const fetchTemplates = useCallback(async () => {
    try {
      const params = new URLSearchParams({ bank, level: 'L3' });
    ...
    <>
      ...
      <div className="rounded-xl shadow-sm border p-6 mb-6 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
        ...
        <p className="text-sm mb-4 text-gray-500 dark:text-gray-400">
          ...
          Example: &quot;Tell us why&quot; + [Christmas/Halloween/New Year] + &quot;is the best day of the year?&quot;
        </p>
        <form onSubmit={handleAddTemplate} className="space-y-4">
          <div className="flex gap-4 flex-wrap">
            ...
            <div className="flex-1 min-w-[150px]">
              ...
              <input
                ...
                placeholder="is the best day of the year?"
                className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
              />
            </div>
          </div>
          <div>
            ...
            <input
              ...
              placeholder="my birthday, Chinese New Year, New Year, Christmas, Halloween"
              className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
            />
          </div>
          <button
      ...
      <div className="rounded-xl shadow-sm border overflow-hidden bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
        {loading ? (
          <div className="p-8 text-center text-gray-600 dark:text-gray-400">Loading templates...</div>
        ) : templates.length === 0 ? (
